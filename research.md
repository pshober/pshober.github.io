...
<div class="container">
  <header class="page-head">
    ...
    <h1>Research</h1>
    <p class="lede">I study how small bodies deliver material to Earth, connecting what
      telescopic surveys see in space, what wide-field camera networks catch coming in,
      and what we analyze in the lab afterwards. Across all of it, <em>what reaches the
      ground is only a filtered sample of what actually hits Earth.</em></p>
    <div class="hero__topics" style="margin-top:1.2rem">
      {% for t in site.data.research.interests %}<span class="pill">{{ t }}</span>{% endfor %}
    </div>
  </header>

  <figure class="fig" data-lightbox data-full="{{ '/assets/img/research/fall-sequence.jpg' | relative_url }}" data-cap="From asteroid to meteorite: the sequence my work follows, from small-body dynamics to the sample on the ground.">
  ...
  <section class="section">
    ...
    <div class="callout">
      ...
      You can also see where my namesake asteroid is right now at
